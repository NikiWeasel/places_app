...
import 'package:places_surf/uikit/loading/app_loader_sizes.dart';
...
class AppLoader extends StatelessWidget {
  ...
  /// {@endtemplate}
  const AppLoader._(
      {required this.size, this.color, this.backgroundColor, this.isForScreen = false});

  /// Фабрика для лоадера.
  factory AppLoader.create(
      {required AppLoaderSizes size, Color? color, Color? backgroundColor, bool? isForScreen}) {
    return AppLoader._(size: size,
        color: color,
